...
import 'package:endec_json/src/json_string_deserializer.dart';
...
''';
  ...
  @override
  void run() => _endec.decode(SerializationContext.empty, JsonStringDeserializer(_json));
...
void main(List<String> args) {
  JsonStringBenchmark('json string deserializer').report();
}
